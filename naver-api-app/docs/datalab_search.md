...
![](/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/datalab/search/images/datalab-01.png)
...
![](/proxyapi/rawgit/naver/naver-openapi-guide/master/ko/service-apis/datalab/search/images/datalab-02.png)
...
-d @응답에 성공하면 결괏값을 JSON 형식으로 반환합니다.
...
public class ApiExamDatalabTrend {
    ...
    private static String post(String apiUrl, Map requestHeaders, String requestBody) {
