...
* [카페글 검색 개요](/docs/serviceapi/search/cafearticle/cafearticle.md#카페글-검색-개요)

* [개요](/docs/serviceapi/search/cafearticle/cafearticle.md#개요)

* [사전 준비 사항](/docs/serviceapi/search/cafearticle/cafearticle.md#사전-준비-사항)

* [카페글 검색 API 레퍼런스](/docs/serviceapi/search/cafearticle/cafearticle.md#카페글-검색-api-레퍼런스)

* [카페글 검색 결과 조회](/docs/serviceapi/search/cafearticle/cafearticle.md#카페글-검색-결과-조회)

* [오류 코드](/docs/serviceapi/search/cafearticle/cafearticle.md#오류-코드)

* [검색 API 카페글 검색 구현 예제](/docs/serviceapi/search/cafearticle/cafearticle.md#검색-api-카페글-검색-구현-예제)

## 카페글 검색 개요 

* [개요](/docs/serviceapi/search/cafearticle/cafearticle.md#%EA%B0%9C%EC%9A%94)

* [사전 준비 사항](/docs/serviceapi/search/cafearticle/cafearticle.md#%EC%82%AC%EC%A0%84-%EC%A4%80%EB%B9%84-%EC%82%AC%ED%95%AD)
...
* [카페글 검색 결과 조회](/docs/serviceapi/search/cafearticle/cafearticle.md#%EC%B9%B4%ED%8E%98%EA%B8%80-%EA%B2%80%EC%83%89-%EA%B2%B0%EA%B3%BC-%EC%A1%B0%ED%9A%8C)
...
| rss/channel/item/title | String | 카페 게시글 제목. 제목에서 검색어와 일치하는 부분은 `` 태그로 감싸져 있습니다. |
| rss/channel/item/link | String | 카페 게시글 URL |
| rss/channel/item/description | String | 카페 게시글의 내용을 요약한 패시지 정보. 패시지 정보에서 검색어와 일치하는 부분은 `` 태그로 감싸져 있습니다. |
...
`
        ...
        Naver Open API - cafearticle ::'주식'
        http://search.naver.com
        Naver Search Result
        Mon, 26 Sep 2016 10:42:03 +0900
        1777224110
        
            주식과 비지니스 : 뇌동매매 방지 마인드
            http://openapi.naver.com/l?AAABXIuw7CIBSA4ac5jE24WRgYuNjVicWNtKc2QbQiNvHtxeQfvvyvD9avgbMHy8H5P5QDHchWcTVbaztwC2zqzWnF4ZEOrMP8LH0sqeY95a6TlqQZKkahpKCMa6VIMZd4vEMqEZjLdArXeyzyhsvoNVUWePgBHZyF5XwAAAA=
            제가 주식 강의에서 이 말씀을 왜 드리는가?주식을 비지니스로 생각하시면 보시는 시야가 달라지기 때문에 그렇습니다앞서 말한 자영업에 실패한 분들은 다양한 요인들이 있겠지만 결국 시장 경쟁에서 밀려 문을 닫는... 
            기술적분석 주식공부 모임
            http://cafe.naver.com/darkpak
        
        
            내 손바닥 안 ✌ 주식하는법
            http://openapi.naver.com/l?AAABWLvQ6CMBRGn+Z2JPYHbYcOLdXNRBInt6ZeCokINAWiT29NvuGck3zLiumj4dyA4WCbP0gLypE+Yaf7nGfgBtilLPgOq7ffMFVhGkuIUxxCQpwxFauZIFlTcRKyFpRxJSUZ9ReYPfjhddyW26quke/yTs2jLYfdPVvg7gfltbj+ggAAAA==
            내 손바닥 안 ✌ 주식하는법 흠.. 인사 먼저드릴게요저는 한국자산관리본부에서주식하는법 상담받고 온 처자입니다. 엄마께서는 아직 나이도 어린데주식하면 좀 부담스럽지 않냐 다른 것도 알아보라고 하셨어요&uuml; 뭐... 
            쇼미더리뷰
            http://cafe.naver.com/gogicreeper
